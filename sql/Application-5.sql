...
--
-- Hôte : localhost:8889
-- Généré le : mer. 12 fév. 2025 à 17:59
...
(1, 1, 'Steak au Poivre', 'Un steak juteux avec sauce au poivre noir frais moulu', 29.99, 'Plat Principal', './image/Steak.png', 1),
(2, 1, 'Coq au Vin', 'Poulet mijoté au vin rouge avec légumes de saison', 24.99, 'Plat Principal', './image/Coq_au_vin.png', 1),
(3, 1, 'Tarte Tatin', 'Tarte aux pommes caramélisées et pâte feuilletée', 9.99, 'Dessert', './image/Tarte_tatin.png', 1),
(4, 1, 'Salade César', 'Laitue romaine, parmesan, croûtons et sauce César maison', 12.99, 'Entrée', './image/salad.png', 1),
(5, 2, 'Boeuf Bourguignon', 'Bœuf mijoté au vin rouge avec champignons et lardons', 28.99, 'Plat Principal', './image/Boeuf_bourguignon.png', 1),
(6, 2, 'Cordon Bleu', 'Escalope de poulet farcie au jambon et fromage', 25.99, 'Plat Principal', './image/Cordon_bleu.png', 1),
(7, 2, 'Saumon en Papillotte', 'Saumon frais cuit en papillote aux herbes', 26.99, 'Plat Principal', './image/Saumon_papillotte.png', 1),
(8, 3, 'Margherita Pizza', 'Sauce tomate, mozzarella fraîche et basilic', 12.99, 'Pizza', './image/pizza.png', 1),
(9, 3, 'Pizza Quattro Formaggi', 'Mélange de quatre fromages italiens', 14.99, 'Pizza', './image/pizza2.png', 1),
(10, 3, 'Pizza Pepperoni', 'Pepperoni, mozzarella et sauce tomate', 13.99, 'Pizza', './image/pizza3.png', 1),
(11, 4, 'Pâtes Carbonara', 'Spaghetti à la crème, œuf et lardons', 15.99, 'Pâtes', './image/pasta.png', 1),
(12, 4, 'Lasagne Bolognaise', 'Lasagnes traditionnelles à la sauce bolognaise', 16.99, 'Pâtes', './image/pasta1.png', 1),
(13, 4, 'Tiramisu', 'Dessert italien au café et mascarpone', 7.99, 'Dessert', './image/Tiramisu.png', 1),
(14, 5, 'Sushi Mix', 'Assortiment de sushis variés (12 pièces)', 22.99, 'Sushi', './image/sushi.png', 1),
(15, 5, 'California Roll', 'Rouleaux de crabe, avocat et concombre (8 pièces)', 16.99, 'Maki', './image/sushi1.png', 1),
(16, 5, 'Sashimi Saumon', 'Tranches de saumon frais (10 pièces)', 18.99, 'Sashimi', './image/sushi2.png', 1),
(17, 6, 'Tempura Crevettes', 'Crevettes frites en tempura avec sauce', 17.99, 'Entrée', './image/Tempura_Crevettes.png', 1),
(18, 6, 'Ramen Miso', 'Soupe ramen au miso avec porc chachu', 15.99, 'Plat Principal', './image/Ramen_Miso.png', 1),
(19, 6, 'Mochi Glacé', 'Dessert japonais glacé aux fruits', 6.99, 'Dessert', './image/Mochi_Glace.png', 1);
...
(1, 'The Fancy Fork', 'A fine dining experience.', '123 Main St, City', '123-456-7890', '9:00 AM - 10:00 PM', 50, 4.8, 'French', 'Fancy_fork.jpg', 48.85660000, 2.35220000, '2024-11-19 10:55:13'),
(2, 'Pizza Paradise', 'Best pizza in town!', '456 Elm St, City', '987-654-3210', '11:00 AM - 11:00 PM', 100, 4.5, 'Italian', 'Pizza_paradise.jpg', 48.85670000, 2.35230000, '2024-11-19 10:55:13'),
(3, 'Sushi World', 'Fresh sushi and sashimi.', '789 Oak St, City', '555-123-4567', '12:00 PM - 10:00 PM', 80, 4.7, 'Japanese', 'sushi_world.jpg', 48.85680000, 2.35240000, '2024-11-19 09:55:13'),
(4, 'Le Bistrot Parisien', 'Authentic French cuisine in a cozy atmosphere', '15 Rue de la Paix, Paris', '01-23-45-67-89', '11:30 AM - 11:00 PM', 40, 4.6, 'French', 'bistrot_parisien.jpg', 48.87034000, 2.33186000, '2025-02-11 12:19:11'),
(5, 'Taj Mahal', 'Fine Indian dining experience', '78 Avenue des Champs-Élysées, Paris', '01-98-76-54-32', '12:00 PM - 10:30 PM', 60, 4.4, 'Indian', 'taj_mahal.jpg', 48.86923000, 2.30984000, '2025-02-11 12:19:11'),
(6, 'El Tapas', 'Traditional Spanish tapas bar', '25 Rue du Commerce, Paris', '01-45-67-89-12', '6:00 PM - 2:00 AM', 35, 4.3, 'Spanish', 'el_tapas.jpg', 48.84789000, 2.29456000, '2025-02-11 12:19:11');
...
(1, 'user1@example.com', 'hashedpassword1', 'UserOne', 'https://example.com/profile1.jpg', 'Bio of User One', '2024-11-19 10:55:13', NULL, 1, 0, NULL, 3, 1, 0, NULL),
(2, 'user2@example.com', 'hashedpassword2', 'UserTwo', 'https://example.com/profile2.jpg', 'Bio of User Two', '2024-11-19 10:55:13', NULL, 1, 0, NULL, 3, 0, 1, NULL),
(3, 'ancien.admin@example.com', '$2y$10$ancien_hash', 'ancien_admin', 'ancien_admin.jpg', 'administrateur original', '2025-02-11 13:12:45', NULL, 1, 0, NULL, 3, 1, 0, NULL),
(6, 'benjamin.dronne@gmail.com', '$2y$10$3n.EWoxlhJ7VmQME9zIxueoMoZuixIckK7hbiKX0Hryny8or3Ftb2', 'Benji', NULL, NULL, '2024-12-03 10:08:20', NULL, 1, 0, NULL, 3, 0, 0, NULL),
(17, 'nouvel.admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'super_admin1.jpg', 'administrateur', '2025-02-11 13:02:25', NULL, 1, 0, NULL, 3, 1, 0, NULL),
(18, 'nouvel02.admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin01', 'super_admin1.jpg', 'administrateur', '2025-02-11 13:02:25', NULL, 1, 0, NULL, 3, 1, 0, NULL),
(19, 'marc@gmail.com', '$2y$12$4wjsGr2CgUseZTZFRs8yMOFbApmR2SfcjI8/gemJ.IKN6Ibcg7Dja', 'marc', NULL, NULL, '2025-02-11 13:15:32', '2025-02-12 08:56:59', 1, 0, NULL, NULL, 0, 0, NULL);
