...
--
-- Hôte : localhost:8889
-- Généré le : mer. 16 avr. 2025 à 07:24
...
(20, 7, 'Soupe à l\'Oignon', 'Soupe traditionnelle à l\'oignon gratinée au fromage', 8.99, 'Entrée', './images/dishes/soupe_oignon.png', 1),
(21, 7, 'Escargots de Bourgogne', 'Escargots au beurre d\'ail et aux herbes', 12.99, 'Entrée', './images/dishes/escargots.png', 1),
(22, 7, 'Blanquette de Veau', 'Veau mijoté en sauce blanche avec légumes', 24.99, 'Plat Principal', './images/dishes/blanquette.png', 1),
(23, 7, 'Crème Brûlée', 'Crème vanillée avec croûte de sucre caramélisé', 7.99, 'Dessert', './images/dishes/creme_brulee.png', 1),
(24, 8, 'Foie Gras Maison', 'Foie gras mi-cuit avec chutney de figues', 16.99, 'Entrée', './images/dishes/foie_gras.png', 1),
(25, 8, 'Magret de Canard', 'Magret de canard avec sauce aux fruits rouges', 28.99, 'Plat Principal', './images/dishes/magret.png', 1),
(26, 8, 'Profiteroles', 'Choux à la crème avec sauce au chocolat', 9.99, 'Dessert', './images/dishes/profiteroles.png', 1),
(27, 9, 'Samosas', 'Chaussons frits aux légumes et épices', 7.99, 'Entrée', './images/dishes/samosas.png', 1),
(28, 9, 'Poulet Tandoori', 'Poulet mariné aux épices et cuit au tandoor', 19.99, 'Plat Principal', './images/dishes/tandoori.png', 1),
(29, 9, 'Agneau Biryani', 'Riz parfumé avec agneau et épices', 22.99, 'Plat Principal', './images/dishes/biryani.png', 1),
(30, 9, 'Gulab Jamun', 'Boulettes de lait sucrées au sirop', 6.99, 'Dessert', './images/dishes/gulab.png', 1),
(31, 10, 'Dal Makhani', 'Lentilles noires mijotées en sauce crémeuse', 16.99, 'Plat Principal', './images/dishes/dal.png', 1),
(32, 10, 'Palak Paneer', 'Fromage indien aux épinards', 17.99, 'Plat Principal', './images/dishes/palak.png', 1),
(33, 10, 'Naan Nature', 'Pain indien traditionnel', 3.99, 'Accompagnement', './images/dishes/naan.png', 1),
(34, 11, 'Patatas Bravas', 'Pommes de terre sauce épicée', 6.99, 'Tapas', './images/dishes/patatas.png', 1),
(35, 11, 'Jamón Ibérico', 'Jambon ibérique de bellota', 14.99, 'Tapas', './images/dishes/jamon.png', 1),
(36, 11, 'Tortilla Española', 'Omelette espagnole aux pommes de terre', 8.99, 'Tapas', './images/dishes/tortilla.png', 1),
(37, 11, 'Gambas al Ajillo', 'Crevettes à l\'ail', 12.99, 'Tapas', './images/dishes/gambas.png', 1),
(38, 12, 'Paella Valenciana', 'Paella traditionnelle au poulet et fruits de mer', 24.99, 'Plat Principal', './images/dishes/paella.png', 1),
(39, 12, 'Paella Marinera', 'Paella aux fruits de mer', 26.99, 'Plat Principal', './images/dishes/paella_mar.png', 1),
(40, 12, 'Crema Catalana', 'Crème catalane traditionnelle', 6.99, 'Dessert', './images/dishes/crema.png', 1);
...
(1, 'The Fancy Fork', 'A fine dining experience.', '123 Main St, City', '123-456-7890', '9:00 AM - 10:00 PM', 50, 4.8, 'French', '/images/restaurant/fancy_fork.png', 48.85660000, 2.35220000, '2024-11-19 10:55:13'),
(2, 'Pizza Paradise', 'Best pizza in town!', '456 Elm St, City', '987-654-3210', '11:00 AM - 11:00 PM', 100, 4.5, 'Italian', '/images/restaurant/pizza_paradise.png', 48.85670000, 2.35230000, '2024-11-19 10:55:13'),
(3, 'Sushi World', 'Fresh sushi and sashimi.', '789 Oak St, City', '555-123-4567', '12:00 PM - 10:00 PM', 80, 4.7, 'Japanese', '/images/restaurant/sushi_world.png', 48.85680000, 2.35240000, '2024-11-19 09:55:13'),
(4, 'Le Bistrot Parisien', 'Authentic French cuisine in a cozy atmosphere', '15 Rue de la Paix, Paris', '01-23-45-67-89', '11:30 AM - 11:00 PM', 40, 4.6, 'French', '/images/restaurant/bistrot_parisien.png', 48.87034000, 2.33186000, '2025-02-11 12:19:11'),
(5, 'Taj Mahal', 'Fine Indian dining experience', '78 Avenue des Champs-Élysées, Paris', '01-98-76-54-32', '12:00 PM - 10:30 PM', 60, 4.4, 'Indian', '/images/restaurant/taj_mahal.png', 48.86923000, 2.30984000, '2025-02-11 12:19:11'),
(6, 'El Tapas', 'Traditional Spanish tapas bar', '25 Rue du Commerce, Paris', '01-45-67-89-12', '6:00 PM - 2:00 AM', 35, 4.3, 'Spanish', '/images/restaurant/el_tapas.png', 48.84789000, 2.29456000, '2025-02-11 12:19:11');
...
(17, 'nouvel.admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', '67b3514637879.png', 'administrateur', '2025-02-11 13:02:25', NULL, 1, 0, NULL, 3, 1, 0, NULL),
...
(19, 'marc@gmail.com', '$2y$12$4wjsGr2CgUseZTZFRs8yMOFbApmR2SfcjI8/gemJ.IKN6Ibcg7Dja', 'marc', '67b33f059302f.png', 'Hello, moi c&#039;est Marc', '2025-02-11 13:15:32', '2025-02-17 08:39:27', 1, 0, NULL, NULL, 0, 0, NULL),
